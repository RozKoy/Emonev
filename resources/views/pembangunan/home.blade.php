...
@section('title', 'Rencana Pembangunan | Emonev')
@section('location', 'Rencana Pembangunan')
...
@section('content')
	...
	<div class="bg-white rounded-lg shadow p-4">
		...
		<div class="flex text-sm items-center">
			<h2 class="text-gray-500 font-semibold">RENCANA <span class="bg-pink-500 font-normal rounded-lg py-0.5 px-1.5 text-white">PEMBANGUNAN</span></h2>
		</div>
