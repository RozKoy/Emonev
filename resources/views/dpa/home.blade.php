...
@section('content')
	...
	<div class="bg-white rounded-lg shadow p-4">
		...
		<div class="flex text-sm items-center">
			<h2 class="text-gray-500 font-semibold">DAFTAR DOKUMEN PELAKSANAAN ANGGARAN</h2>
			<a href="#" class="focus:outline-none text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:ring-green-300 font-medium rounded-lg px-3 py-1.5 ml-auto dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 shadow-md">+ Tambah</a>
		</div>
